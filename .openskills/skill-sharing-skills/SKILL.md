...
### ✅ Good: 1. Ensure You're on Main and Synced
...
### ✅ Good: 5. Push to Your Fork

```bash
git push -u origin "add-${skill_name}-skill"
```

### ✅ Good: 6. Create Pull Request
...
### ✅ Good: Here's a complete example of sharing a skill called "async-patterns":
...
- Individual skills can be reviewed, iterated, and merged independently.
